...
const data = [
  ...
  {
    image: "https://media.nihalfashions.com/media/wysiwyg/gowns-for-girls.jpg",
    category: "Kids",
  },
  {
    image:
          ...
          {data.map((item: any, index: number) => (
            ...
            >
              <Stack sx={{ textAlign: "center" }}>
                <Avatar
                  variant="square"
                  sx={{ width: "120px", height: "120px", my: "10px" }}
                  src={item.image}
                />
...
export default CardsFilterProducts;
